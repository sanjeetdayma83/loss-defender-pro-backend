...
export const WHATSAPP_NOTIFICATION_QUEUE = 'whatsapp-notification-queue';
...
export const TEMPLATE_PASSWORD_RESET = 'PASSWORD_RESET';

export const TEMPLATE_VERIFY_EMAIL = 'VERIFY_EMAIL';

export const TEMPLATE_ORDER_CREATED = 'ORDER_CREATED';

export const TEMPLATE_ORDER_COMPLETED = 'ORDER_COMPLETED';

export const TEMPLATE_ORDER_CANCELLED = 'ORDER_CANCELLED';

export const TEMPLATE_RETURN_CREATED = 'RETURN_CREATED';

export const TEMPLATE_RETURN_APPROVED = 'RETURN_APPROVED';

export const TEMPLATE_RETURN_REJECTED = 'RETURN_REJECTED';

export const TEMPLATE_RETURN_REFUNDED = 'RETURN_REFUNDED';

export const TEMPLATE_RETURN_REPLACED = 'RETURN_REPLACED';

export const TEMPLATE_CLAIM_CREATED = 'CLAIM_CREATED';

export const TEMPLATE_CLAIM_APPROVED = 'CLAIM_APPROVED';

export const TEMPLATE_CLAIM_REJECTED = 'CLAIM_REJECTED';

export const TEMPLATE_AI_ANALYSIS_COMPLETED = 'AI_ANALYSIS_COMPLETED';

/**
 * Scheduled Notifications
 */
export const NOTIFICATION_SCHEDULER_INTERVAL_MS = 60_000;
 ...
 * Default Sender
 */
export const DEFAULT_EMAIL_FROM = 'support@lossdefenderpro.in';

export const DEFAULT_SMS_SENDER = 'LossDefender';

export const DEFAULT_PUSH_ICON = 'notification';

/**
 * Firebase Topics
 */
export const FIREBASE_TOPIC_ALL_USERS = 'all-users';

export const FIREBASE_TOPIC_ADMINS = 'admins';

export const FIREBASE_TOPIC_WAREHOUSE = 'warehouse';

export const FIREBASE_TOPIC_OPERATIONS = 'operations';
