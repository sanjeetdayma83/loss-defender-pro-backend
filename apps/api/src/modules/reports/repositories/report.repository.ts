...
export class ReportsRepository {
  ...
  async create(
    ...
    return this.prisma.report.create({
      data:
        dto as Prisma.ReportCreateInput,
    });
  }
  ...
  async update(
    ...
    return this.prisma.report.update({
      where: { id },
      data:
        dto as Prisma.ReportUpdateInput,
    });
  }
    /**
   * -------------------------------------------------------
  ...
  findFirst(
    args: Prisma.ReportFindFirstArgs,
  ) {
  ...
  createMany(
    args: Prisma.ReportCreateManyArgs,
  ) {
    return this.prisma.report.createMany(
      args,
    );
  }

  upsert(
    args: Prisma.ReportUpsertArgs,
  ) {
