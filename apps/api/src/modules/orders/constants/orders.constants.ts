...
export const ORDER_VERIFICATION_QUEUE = 'order-verification-queue';

export const ORDER_ANALYTICS_QUEUE = 'order-analytics-queue';
...
export const ORDER_PACKING_STARTED_EVENT = 'ORDER_PACKING_STARTED';

export const ORDER_PACKING_COMPLETED_EVENT = 'ORDER_PACKING_COMPLETED';

export const ORDER_RECORDING_STARTED_EVENT = 'ORDER_RECORDING_STARTED';

export const ORDER_VERIFIED_EVENT = 'ORDER_VERIFIED';

export const ORDER_SHIPPED_EVENT = 'ORDER_SHIPPED';

export const ORDER_DELIVERED_EVENT = 'ORDER_DELIVERED';

export const ORDER_CANCELLED_EVENT = 'ORDER_CANCELLED';

export const ORDER_RETURN_CREATED_EVENT = 'ORDER_RETURN_CREATED';

export const ORDER_CLAIM_CREATED_EVENT = 'ORDER_CLAIM_CREATED';
